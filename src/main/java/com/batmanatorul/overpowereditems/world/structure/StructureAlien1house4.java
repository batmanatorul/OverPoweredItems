...
package com.batmanatorul.overpowereditems.world.structure;
...
import com.batmanatorul.overpowereditems.world.WorldDimension1;
import com.batmanatorul.overpowereditems.ElementsOverpoweredItems;

@ElementsOverpoweredItems.ModElement.Tag
public class StructureAlien1house4 extends ElementsOverpoweredItems.ModElement {
	public StructureAlien1house4(ElementsOverpoweredItems instance) {
		super(instance, 36);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == WorldDimension1.DIMID) {
			dimensionCriteria = true;
			isNetherType = WorldDimension1.NETHER_TYPE;
		}
		...
		if ((random.nextInt(1000000) + 1) <= 2250) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("overpowereditems", "alien1_house_4"));
				if (template == null)
					return;
