...
public class StructureAlien1house3 extends ElementsOverpoweredItems.ModElement {
	public StructureAlien1house3(ElementsOverpoweredItems instance) {
		super(instance, 35);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2250) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("overpowereditems", "alien1_house_3"));
				if (template == null)
					return;
