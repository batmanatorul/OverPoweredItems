...
public class StructureAlien1house2 extends ElementsOverpoweredItems.ModElement {
	public StructureAlien1house2(ElementsOverpoweredItems instance) {
		super(instance, 34);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2250) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("overpowereditems", "alien1_house_2"));
				if (template == null)
					return;
