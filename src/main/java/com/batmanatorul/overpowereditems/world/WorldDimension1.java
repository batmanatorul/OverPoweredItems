...
package com.batmanatorul.overpowereditems.world;
...
import com.batmanatorul.overpowereditems.item.ItemDimension1;
import com.batmanatorul.overpowereditems.block.BlockDimension1portalblock;
...
public class WorldDimension1 extends ElementsOverpoweredItems.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("overpowereditems:dimension1_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldDimension1(ElementsOverpoweredItems instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemDimension1().setUnlocalizedName("dimension1").setRegistryName("dimension1"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension dimension1 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("dimension1", "_dimension1", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemDimension1.block, 0, new ModelResourceLocation("overpowereditems:dimension1", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockDimension1portalblock.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockDimension1portalblock.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("dimension1_portal");
			setRegistryName("dimension1_portal");
			setLightLevel(0F);
		}
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down())
							.getBlock() != BlockDimension1portalblock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockDimension1portalblock.block.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockDimension1portalblock.block.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockBiome1groundblock.block.getDefaultState();
		private static final IBlockState STONE2 = BlockBiome1undergroundblock.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("overpowereditems:dimension1biome")),};
