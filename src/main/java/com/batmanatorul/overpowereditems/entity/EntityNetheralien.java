...
import com.batmanatorul.overpowereditems.procedure.ProcedureNetheralienPlayerCollidesWithThisEntity;
import com.batmanatorul.overpowereditems.procedure.ProcedureAlienRobotEntityDies;
import com.batmanatorul.overpowereditems.item.ItemNetherAlienPickaxe;
import com.batmanatorul.overpowereditems.ElementsOverpoweredItems;

@ElementsOverpoweredItems.ModElement.Tag
public class EntityNetheralien extends ElementsOverpoweredItems.ModElement {
	public static final int ENTITYID = 7;
	public static final int ENTITYID_RANGED = 8;
	public EntityNetheralien(ElementsOverpoweredItems instance) {
		super(instance, 41);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("overpowereditems", "netheralien"), ENTITYID).name("netheralien").tracker(64, 3, true).egg(-1, -1).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelOverpower_Boss_model(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("overpowereditems:textures/2.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemNetherAlienPickaxe.block, (int) (1)).getItem();
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("block.anvil.step"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureNetheralienPlayerCollidesWithThisEntity.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				ProcedureAlienRobotEntityDies.executeProcedure($_dependencies);
			}
		}
